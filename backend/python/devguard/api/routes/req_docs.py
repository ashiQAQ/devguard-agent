...
def doc_to_dict(doc: RequirementDoc) -> Dict:
    return {
        ...
        "format": doc.format, "version": doc.version, "doc_type": doc.doc_type,
        "project": doc.project, "module": doc.module, "status": doc.status,
        "req_count": doc.req_count, "feature_count": doc.feature_count,
